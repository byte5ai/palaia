...
// Paths SPEC-110 builds a real screen for — everything else in NAV_GROUPS
// still falls through to ComingSoon below, so no nav destination is ever a
// dead link (SPEC-109's rule, carried forward).
const BUILT_PATHS = new Set(["/", "/explorer", "/clients"]);
